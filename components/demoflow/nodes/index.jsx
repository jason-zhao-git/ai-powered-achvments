export const mainNodes = [
  ...
  export const tutorialNodes = [
    ...
    },
    {
      ...
      "data": {
        "name": "Parent Check",
        "description": "Only when all previous achievements acomplished can you complete the child quest.",
        "arrowStyle": "none"
      },
      "position": {
    ...
    },
    {
      ...
      "data": {
        ...
        "description": "Please go ahead and check out the example quests and edit/play with them at will!",
        "arrowStyle": "none"
      },
      "position": {
        "x": 152.1919285792498,
    ...
    },
    {
      ...
      "data": {
        ...
        "description": "Creating a cycle is not allowed! This will cause the tasks to be unable to be completed in order.",
        "arrowStyle": "none"
      },
      "position": {
    ...
    },
    {
      ...
      "data": {
        "name": "Sockets",
        "description": "You can set socket type in add node session and connect however many edges to want, as long as it is from a Source(outward arrow) to Target(inward arrow).",
        "arrowStyle": "none"
      },
      "position": {
    ...
    },
    {
      ...
      "data": {
        ...
        "description": "The completed quest will be shiny! Only after you completed all the parent quest can you mark a new quest conpleted. Play with the setup above.",
        "arrowStyle": "none"
      },
      "position": {
    ...
    },
    {
      ...
      "data": {
        "name": "Exp2",
        "description": "This is an example, with 3 source sockets and 1 target socket.",
        "subtasks": [],
        "connections": {
          "up": "source",
          "down": "source",
    ...
    },
    {
      ...
      "data": {
        "name": "Welcome!",
        "description": "Welcome to the tutorial session, here we will talk throught basic operations to help you build your quest!",
        "arrowStyle": "none"
      },
      "position": {
        "x": 276.0195731644893,
  ...
  export const vocalNodes = [
    ...
    },
    {
      ...
      "data": {
        "name": "Mic Hog",
        "description": "Master 20 songs/ add them to your kareoke list.",
        "subtasks": [],
        "connections": {
          "up": "source",
          "down": "target",
    ...
    },
    {
      ...
      "position": {
        "x": 255.08607201421103,
        "y": -47.751958337701566
      },
      "type": "task",
      "measured": {
        "width": 46,
    ...
    },
    {
      ...
      "position": {
        "x": 10.160936464576732,
        "y": -49.875422487180856
      },
      "type": "task",
      "measured": {
        "width": 46,
